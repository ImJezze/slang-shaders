...
#define PARAM_SCREEN_FREQUENCY int(global.SCREEN_FREQUENCY) == 50 ? 48 : int(global.SCREEN_FREQUENCY) // special case: map 50Hz to 48Hz
...
#define PARAM_HALATION_INTENSITY mix_master(global.HALATION_INTENSITY, 0.0, 0.0, 2.0)
