...
//    2: Slot-mask
//    3: Shadow-mask
// @colors - the color types [1, 4]
//    1: white, black
//    2: magenta, green
//    3: red, green, blue
//    4: red, green, blue, black
vec3 get_subpixel_color(vec2 pixCoord, int size, int type, int colors)
{
    vec3 color = White;
...
//    2: green, magenta
//    3: red, green, blue
//    4: red, green, blue, solid
// @radius - the corner radius of the sub-pixel
// @smoothness - the smoothness of the sub-pixel
vec3 get_subpixel_color(vec2 pixCoord, int size, int type, int colors, float radius, float smoothness)
{
    vec3 color = White;
